...
xplr.config.modes.builtin.selection_ops = {
    ...
    key_bindings = {
        on_key = {
            ...
            ["u"] = {
                help = "clear selection",
                messages = {"ClearSelection", "PopMode"}
            }
        }
    }
}
...
xplr.config.modes.builtin.search = {
    ...
    key_bindings = {
        ...
        default = {
            messages = {"UpdateInputBufferFromKey", "SearchFuzzyFromInput", "ExplorePwdAsync"}
        }
    }
}
...
xplr.config.modes.builtin.vroot = {
    ...
    key_bindings = {
        on_key = {
            ...
            ["ctrl-r"] = {
                help = "reset vroot",
                messages = {"PopMode", "ResetVroot"}
            },
            ["ctrl-u"] = {
                help = "unset vroot",
                messages = {"PopMode", "UnsetVroot"}
            }
        }
    }
}
